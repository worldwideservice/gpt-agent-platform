...
import { SearchIcon, BellIcon, LayersIcon, XIcon, BellOffIcon } from "./icons"

export function Header() {
  const [showNotifications, setShowNotifications] = useState(false)
  const [notificationCount, setNotificationCount] = useState(3) // Dynamic count instead of static 250
