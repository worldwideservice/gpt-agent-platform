...
export const ChannelsSettings = ({
 ...
 <p className="text-sm font-medium text-gray-700 mb-1">Все каналы</p>
 </div>
 <KwidSwitch
 ...
 <h3 className="text-sm font-medium text-gray-600 каналы</h3>
 {channels.map((channel) => (
 <div key={channel.id} className="flex items-center justify-between">
 <div className="flex-1">
 <p className="text-sm font-medium text-gray-700 mb-1">{channel.name}</p>
