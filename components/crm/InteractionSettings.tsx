...
export const InteractionSettings = ({
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
      <div className="flex items-center space-x-2 mb-4">
        <MessageSquare className="w-5 h-5 text-gray-600 dark:text-gray-400" />
        <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Взаимодействие</h2>
      </div>

      <div className="flex items-center justify-between">
        <div className="flex-1">
          <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Проверять перед отправкой</p>
