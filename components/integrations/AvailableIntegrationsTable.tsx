...
// InstallIntegrationModal removed - not needed anymore
...
export const AvailableIntegrationsTable = ({
 ...
 <button
 type="button"
 className="text-sm font-medium text-gray-950 cursor-default"
 disabled
 >
 {integration.name}
 </button>
 ...
 type="button"
 disabled
 className="fi-link group/link relative inline-flex items-center justify-center outline-none fi-size-sm fi-link-size-sm gap-1 opacity-50 cursor-not-allowed"
 >
