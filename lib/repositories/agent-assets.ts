...
export const getAgentAssets = async (
 ...
 if (error) {
 logger.error('Failed to fetch agent assets', error)
...
export const getAgentAssetsForOrganization = async (
 organizationId: string,
 limit = 10,
): Promise<AgentAsset[]> => {
 const supabase = getSupabaseServiceRoleClient()
 ...
 if (error) {
 logger.error('Failed to fetch agent assets for organization', error)
...
export const getAgentAssetById = async (
 ...
 if (error) {
 logger.error('Failed to fetch agent asset', error)
...
export const updateAssetStatus = async (
 ...
 if (updateError) {
 logger.error('Failed to update asset status', updateError)
