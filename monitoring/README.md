...
Полный стек мониторинга для Worker сервиса с использованием Prometheus, Grafana и Alertmanager.
...
### Prometheus
- Собирает метрики с Worker сервиса каждые 15 секунд
- Хранит метрики 30 дней
- Оценивает правила алертов

### Grafana
- Визуализация метрик
- Дашборды для мониторинга Worker
