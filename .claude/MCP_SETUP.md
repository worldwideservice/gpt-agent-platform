...
- **Статус**: ✅ Настроен с токеном для проекта `rpzchsgutabxeabbnwas`
- **Использование**: SQL запросы, миграции, управление таблицами
...
### 4. Context7 (`context7`)
- **Возможности**: Актуальная документация библиотек (Upstash)
- **Статус**: ✅ Настроен с API ключом
- **Использование**: Доступ к свежей документации (Next.js, React, Supabase и др.)

### 5. Magic (`magic`)
- **Возможности**: AI-генератор UI компонентов (21st.dev)
- **Статус**: ✅ Настроен с API ключом
- **Использование**: Генерация production-ready компонентов с TypeScript
