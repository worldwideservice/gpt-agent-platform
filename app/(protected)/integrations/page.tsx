    ...
    <div className="space-y-6">
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        ...
        >
          <div className="space-y-4">
            <div className="flex items-center justify-end">
              <KwidButton variant="outline" size="sm" onClick={() => void fetchStatus()} disabled={isLoading}>
                Обновить
              </KwidButton>
            </div>
        ...
        <KwidSection title="Статус подключения">
          {isLoading ? (
            <p className="text-sm text-gray-500 dark:text-gray-400">Загрузка статуса...</p>
          ) : error ? (
            <div className="flex items-start space-x-3 rounded-lg border border-orange-200 bg-orange-50 p-4 text-orange-800 dark:border-orange-800 dark:bg-orange-900/20 dark:text-orange-400">
            ...
            <div className="space-y-3 text-sm text-gray-700 dark:text-gray-300">
              <div>
                <span className="font-medium text-gray-900 dark:text-white">Домен:</span> {connection.base_domain}
              </div>
              <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Интеграция с Kommo ещё не настроена.</p>
          )}
        </KwidSection>
      </section>
    </div>
