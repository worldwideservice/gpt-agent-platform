    ...
    <div className="space-y-6">
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        <Card className="p-6">
          <div className="mb-4 flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Kommo CRM</h2>
                <p className="text-sm text-gray-500 dark:text-gray-400">OAuth 2.0 подключение и автоматическая синхронизация</p>
              </div>
            </div>
        ...
        <Card className="p-6">
          ...
          {isLoading ? (
            <p className="mt-4 text-sm text-gray-500 dark:text-gray-400">Загрузка статуса...</p>
          ) : error ? (
