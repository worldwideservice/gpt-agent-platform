...
import { Settings, Users, Zap, Clock, Plug, Settings2, ChevronRight, RefreshCw } from 'lucide-react'
...
const KommoIntegrationEditPage = async ({ params }: KommoIntegrationEditPageProps) => {
  ...
  return (
    <div className="space-y-8">
      {/* Breadcrumbs */}
      <nav className="flex items-center gap-2" aria-label="Хлебные крошки">
        <Link
          href={agentsPath}
