...
import { KwidButton, KwidInput, KwidSelect, KwidTextarea, KwidTabs, KwidTabsContent, KwidSection } from '@/components/kwid'
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <KwidTabsContent value="knowledge" className="space-y-6">
          ...
          {/* Список знаний */}
          <KwidSection
            title={`Загруженные знания (${knowledge.length})`}
          >
              {isLoading ? (
