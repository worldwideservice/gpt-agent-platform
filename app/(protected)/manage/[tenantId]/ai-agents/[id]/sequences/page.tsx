...
export const metadata: Metadata = {
  title: 'Цепочки',
  description: 'Управление цепочками AI-агента',
}
...
const SequencesPage = async ({ params }: SequencesPageProps) => {
  ...
  const currentPath = `/manage/${tenantId}/ai-agents/${agentId}/sequences`
  ...
  const tabs = [
    ...
    { value: 'chains', label: 'Цепочки', icon: Clock, href: currentPath },
