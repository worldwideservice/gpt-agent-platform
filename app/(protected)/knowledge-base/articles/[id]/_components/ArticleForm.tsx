              ...
              <div className="space-y-2">
                <nav className="flex flex-wrap items-center gap-2 text-xs uppercase tracking-wide text-gray-400 dark:text-gray-500">
                  ...
                  <span className="font-semibold text-gray-500 dark:text-gray-400">
                    {isNew
                      ? "Новая статья"
                      : (initialArticle?.title ?? "Редактирование")}
                  </span>
                </nav>
                ...
                <p className="max-w-2xl text-sm text-gray-500 dark:text-gray-400">
                  Создайте статью для базы знаний, которую смогут использовать
                  AI-агенты
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="rounded-xl bg-gray-50 p-4 dark:bg-gray-800">
                ...
                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                  Статьи базы знаний используются AI-агентами для ответов на
                  вопросы пользователей. Чем точнее и подробнее контент, тем
                  лучше будут ответы агента.
                </p>
              </div>
