        ...
        <KwidTabsContent value="files" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <p className="text-sm text-slate-500 dark:text-gray-400">
                Загрузите документы о компании, они будут автоматически
                обработаны и добавлены в базу знаний. Система автоматически
                извлечет Knowledge Graph (сущности и связи) для осмысленного
                понимания контента.
              </p>
            </CardHeader>
            <CardContent>
        ...
        <KwidTabsContent value="memory" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <p className="text-sm text-slate-500 dark:text-gray-400">
                Агент автоматически запоминает важные факты из взаимодействий с
                клиентами
              </p>
            </CardHeader>
            <CardContent>
              <div className="rounded-xl border border-dashed border-slate-200 bg-slate-50 p-10 text-center dark:border-gray-800 dark:bg-gray-800">
                ...
                <p className="mt-2 text-sm text-slate-500 dark:text-gray-400">
                  Память формируется автоматически на основе диалогов с
                  клиентами
                </p>
              </div>
            </CardContent>
