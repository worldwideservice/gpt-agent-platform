    ...
    <div className="rounded-xl border border-custom-200 bg-custom-50/60 p-6 dark:border-custom-800 dark:bg-custom-900/20">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-custom-900 dark:text-custom-100">Настройте воронки и этапы</h3>
        ...
        <Link href={tenantId ? `/manage/${tenantId}/ai-agents/${agentId}/pipelines` : `/agents/${agentId}/pipelines`}>
          <KwidButton variant="outline" size="md" className="border-custom-300 bg-white text-custom-700 hover:bg-custom-100 dark:border-custom-700 dark:bg-gray-800 dark:text-custom-300 dark:hover:bg-custom-900/20">
