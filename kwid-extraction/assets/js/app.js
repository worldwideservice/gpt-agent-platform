(() => {
  var Z = Object.create,
    ...
    ie = (s, n) => () => (n || (n = {
      exports: {}
    }, s(n.exports, n)), n.exports),
    oe = (s, n, p) => {
      if (n && typeof n == "object" || typeof n == "function")
        for (let d of re(n)) !te.call(s, d) && d !== "default" && L(s, d, {
          get: () => n[d],
          enumerable: !(p = ne(n, d)) || p.enumerable
        });
      return s
    },
    se = s => oe(ae(L(s != null ? Z(ee(s)) : {}, "default", s && s.__esModule && "default" in s ? {
      get: () => s.default,
      enumerable: !0
    } : {
      value: s,
    ...
    fe = ie((s, n) => {
      (function(p, d, M) {
        ...
        function T(e) {
          ...
          return h[e.which] ? h[e.which] : g[e.which] ? g[e.which] : String.fromCharCode(e.which).toLowerCase()
        }
        ...
        function I(e, t) {
          var a, c, b, P = [];
          for (a = X(e), b = 0; b < a.length; ++b) c = a[b], q[c] && (c = q[c]), t && t != "keypress" && y[c] && (c = y[c], P.push("shift")), O(c) && P.push(c);
          return t = U(c, P, t), {
            key: c,
            modifiers: P,
            action: t
        ...
        function v(e) {
          ...
          function j(r, o, l, i, u, m) {
            ...
            for (k == "keyup" && O(r) && (o = [r]), f = 0; f < t._callbacks[r].length; ++f)
              if (_ = t._callbacks[r][f], !(!i && _.seq && a[_.seq] != _.level) && k == _.action && (k == "keypress" && !l.metaKey && !l.ctrlKey || V(o, _.modifiers))) {
                var Q = !i && _.combo == u,
          ...
          function N(r, o, l, i, u) {
            ...
            f = I(r, l), t._callbacks[f.key] = t._callbacks[f.key] || [], j(f.key, f.modifiers, {
              type: f.action
            }, i, r, u), t._callbacks[f.key][i ? "unshift" : "push"]({
              callback: o,
          ...
          }, C(e, "keypress", G), C(e, "keydown", G), C(e, "keyup", G)
        }
        v.prototype.bind = function(e, t, a) {
          ...
          var e = v(d);
          for (var t in e) t.charAt(0) !== "_" && (v[t] = function(a) {
            return function() {
              return e[a].apply(e, arguments)
            }
          }(t))
        }, v.init(), p.Mousetrap = v, typeof n < "u" && n.exports && (n.exports = v), typeof define == "function" && define.amd && define(function() {
          return v
        })
  ...
  var le = s => {
      s.directive("mousetrap", (n, {
        ...
        let h = () => d ? M(d) : n.click();
        p = p.map(g => g.replace(/--/g, " ").replace(/-/g, "+").replace(/\bslash\b/g, "/")), p.includes("global") && (p = p.filter(g => g !== "global"), R.default.bindGlobal(p, g => {
          g.preventDefault(), h()
        })), R.default.bind(p, g => {
          g.preventDefault(), h()
        })
  ...
  document.addEventListener("alpine:init", () => {
    window.Alpine.plugin(F), window.Alpine.store("sidebar", {
      ...
      toggleCollapsedGroup: function(n) {
        this.collapsedGroups = this.collapsedGroups.includes(n) ? this.collapsedGroups.filter(p => p !== n) : this.collapsedGroups.concat(n)
      },
      close: function() {
        this.isOpen = !1
      },
    ...
    window.Alpine.store("theme", s === "dark" || s === "system" && window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"), window.addEventListener("theme-changed", n => {
      let p = n.detail;
      localStorage.setItem("theme", p), p === "system" && (p = window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"), window.Alpine.store("theme", p)
      ...
      window.Alpine.store("theme") === "dark" ? document.documentElement.classList.add("dark") : document.documentElement.classList.remove("dark")
    })
  });
})();