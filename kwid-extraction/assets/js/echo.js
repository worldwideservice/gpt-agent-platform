(() => {
  ...
  var Ei = (l, h, a, c) => {
    if (h && typeof h == "object" || typeof h == "function")
      for (let s of Pi(h)) !Oi.call(l, s) && s !== a && he(l, s, {
        get: () => h[s],
      ...
      return function(l) {
        ...
        return a.m = l, a.c = h, a.d = function(c, s, f) {
          ...
          if (a.r(f), Object.defineProperty(f, "default", {
            ...
            for (var d in c) a.d(f, d, function(N) {
              return c[N]
            }.bind(null, d));
          return f
        }, a.n = function(c) {
                  ...
                  return Hn(this, function(g) {
                    switch (g.label) {
                      ...
                      case 2:
                        ...
                        else return _ = b.buildLogSuffix("authorizationEndpoint"), A.error("Invalid auth response for channel '" + this.name + "', " + ("expected 'channel_data' field. " + _ + ", ") + "or the user should be signed in."), r("Invalid auth response"), [2];
                        g.label = 3;
                      case 3:
                        return r(o, u), [2]
                    }
            ...
            return t.prototype.connect = function() {
              ...
              return U({}, n, {
                connected: function(i) {
                  r.activityTimeout = Math.min(r.options.activityTimeout, i.activityTimeout, i.connection.activityTimeout || 1 / 0), r.clearUnavailableTimer(), r.setConnection(i.connection), r.socket_id = r.connection.id, r.updateState("connected", {
        ...
        var ur = function() {
            ...
            return e.prototype.isSupported = function() {
              ...
              var r = this.strategy,
                i, o = new Q(this.options.delay, function() {
                  i = r.connect(t, n)
                });
              return {
                abort: function() {
        ...
        var pr = function(e, t, n) {
            ...
            var o = Object.assign({}, t, {
              ...
              ae = new Y([new it(ot(oe), new kt([oe, new lt(se, {
                delay: 4e3
              })]), se)], _),
              xt = new it(ot(ae), ae, bi),
              Ot;
            return t.useTLS ? Ot = new kt([ie, new lt(xt, {
              delay: 2e3
            })]) : Ot = new kt([ie, new lt(_i, {
              delay: 2e3
            }), new lt(xt, {
              delay: 5e3
          ...
          vr = function() {
            ...
            })), e.hooks.isInitialized() ? e.changeState("initialized") : e.hooks.file ? (e.changeState("initializing"), S.load(e.hooks.file, {
...
`);
        ...
        var $ = Ct,
          ...
          Sr = function() {
            ...
            return e.prototype.send = function(t) {
              ...
              this.readyState === $.OPEN && this.onmessage && this.onmessage({
                data: t
              })
        ...
        var ft = Tt,
          Dr = function() {
            ...
            return e.prototype.log = function(t, n) {
              t <= this.options.level && (this.events.push(U({}, n, {
                timestamp: j.now()
        ...
        var Fr = m.Transports,
          Br = function(e, t, n, r, i, o) {
            ...
            }, i), _ = new zr(t, r, o ? o.getAssistant(u) : u, i)) : _ = Xr, _
          },
          Xr = {
            isSupported: function() {
              return !1
        ...
        var hi = ui,
          ...
          ee = function() {
            function e(t, n) {
              ...
              }), this.user = new pi(this), e.isReady && this.connect()
            }
  ...
  function R(l, h, a) {
    return h && le(l.prototype, h), a && le(l, a), Object.defineProperty(l, "prototype", {
      writable: !1
    }), l
  }
  ...
  var Lt = function(l) {
    ...
    be = function() {
      ...
      return R(l, [{
        ...
        key: "connect",
        value: function() {
          if (this.options.broadcaster == "reverb") this.connector = new fe(at(at({}, this.options), {
            cluster: ""
          }));
