(() => {
  ...
  var j = (i, t, e, s) => {
    if (t && typeof t == "object" || typeof t == "function")
      for (let n of Y(t)) !W.call(i, n) && n !== e && N(i, n, {
        get: () => t[n],
    ...
    i.data("notificationComponent", ({
      ...
      configureAnimations: function() {
        ...
        Livewire.hook("commit", ({
          ...
          s.snapshot.data.isFilamentNotificationsComponent && requestAnimationFrame(() => {
      ...
      close: function() {
        this.isShown = !1, setTimeout(() => window.dispatchEvent(new CustomEvent("notificationClosed", {
          detail: {
            id: t.id
          }
